...
public class HoadonDAO {
    ...
    public boolean AddHoadonDAO(HoadonDTO hdDAO){
        ...
        String sql = "INSERT INTO 'tbl_hoadon'('id_nhanvien','id_khachhang','id_khuyenmai','ngay_lap','tong_hoadon','giolap_hoadon')"
        + "VALUE ('"+ hdDAO.getIdNhanvienDTO() + "'"
