...
public class NhanvienDAO {
        ...
        try {
            ...
            if(rs!=null){
                while(rs.next()){
                    ...
                    nv.setSdtNhanvien(rs.getInt("sdt_nv"));
                    nv.setChucvuNhanvien(rs.getString("chucvu_nv"));
                    nv.setLuongNhanvien(rs.getDouble("luong_nv"));
                    nv.setTrangThaiNhanVien(rs.getString("trangthai_nv"));
    ...
    public boolean themNV(NhanvienDTO nv){
            ...
            String sSQL="INSERT INTO `tbl_nhanvien"
                    + "`(`id_nhanvien`, `ten_nv`, `ho_nv`, `diachi_nv`, `sdt_nv`, `tuoi_nv`, `chucvu_nv`, `luong_nv`,  `trangthai_nv`) "
                    + "VALUES "
                    + "('"+nv.getIdNhanvien()+"','"+nv.getTenNhanvien()+"'),'"+nv.getHoNhanvien()+"','"+nv.getDiaChiNhanvien()+"','"+nv.getSdtNhanvien()+"','"+nv.getTuoiNhanvien()+"','"+nv.getChucvuNhanvien()+"','"+nv.getLuongNhanvien()+"','"+nv.getTrangThaiNhanVien()+"'";
